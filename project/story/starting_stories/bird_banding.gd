...
var options := {
	...
	"Bird Banding":
	{
		"text": '"I can\'t believe we found a [i]cardinal[/i]! They\'re so much bigger than I thought!"',
		"effects": {
			"engagement": +1,
			"science": +1
		}
	...
	"Video Games": {
		"text": [
			"You both play the best fighting game known to man: [i]Hit People With Sticks 3: [b]Steel Thunder[/b][/i].",
